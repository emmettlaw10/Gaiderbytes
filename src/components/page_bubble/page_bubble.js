...
const PageBubble = ({ title, description, buttonTitle, navigateUrl }) => {
  ...
  return (
    <div>
        <div className='w-full h-auto bg-[#E2E8F0] mt-[64px] flex flex-col items-center rounded-md'>
            <h1 className="font-[800] sm:text-[20px] md:text-[24px] lg:text-[30px] xl:text-[40px] leading-[150%] pt-[32px]">{title}</h1>
            <h2 className="pt-[32px] lg:font-[700] lg:text-[25px]">{description}</h2>
            {buttonTitle ? (
